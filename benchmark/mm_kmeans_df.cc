...
class KmeansDf {
 ...
 public:
  KmeansDf(int rank, const std::string &data_path,
  ...
  void to_shared_file() {
    ...
    std::vector<Row> window(window_count_);
...
int main(int argc, char **argv) {
  ...
  KmeansDf kmeans_df(rank, data_path, k, window_count, rep);
